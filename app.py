...
landing_page = st.Page("views/landing.py", title="System Welcome", icon="[TARGET]", default=True)
form_page = st.Page("views/input_form.py", title="Student Profile Setup", icon="[FORM]")
dashboard_page = st.Page("views/dashboard.py", title="Analytics & Interventions", icon="[LIGHTNING]")
